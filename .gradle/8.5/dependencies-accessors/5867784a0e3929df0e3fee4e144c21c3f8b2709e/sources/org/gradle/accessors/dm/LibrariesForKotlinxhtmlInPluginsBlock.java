 ...
 */
@NonNullApi
public class LibrariesForKotlinxhtmlInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForKotlinxhtmlInPluginsBlock(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
